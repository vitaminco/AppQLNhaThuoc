    ...
    public partial class Option : Form
    {
        ...
        private void addThuoc_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                float price = Convert.ToSingle(productDataSet.Tables[0].Rows[0]["giaBan"]);

                // Insert into CT_DONHANG table
                string insertOrderDetailQuery = $"INSERT INTO CT_DONHANG (maDH, maThuoc, soLuong, giaBan) VALUES ('{latestOrderId}', '{maThuoc}', 1, {price})";
                ...
                foreach (DataRow row in orderDetailsDataSet.Tables[0].Rows)
                {
                    ...
                    decimal unitPrice = Convert.ToDecimal(row["giaBan"]);
