    ...
    public partial class Warehouse : Form
    {
        ...
        private void addCate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                query = "INSERT INTO CT_DONHANG (maDH, maThuoc, soLuong, giaBan) VALUES ('" + maDH + "', '" + maThuoc + "', " + soLuong + ", " + donGia + ")";
        ...
        private void updateCate_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string query = "UPDATE CT_DONHANG SET maDH = '" + maDH + "', maThuoc = '" + maThuoc + "', soLuong = '" + soLuong + "',  giaBan = '" + donGia + "' WHERE maDH = '" + maThuoc + "'";
